...
<body>
            ...
            <?php foreach ($lessons as $lesson): ?>
                <div class="lesson-item">
                    ...
                    <div class="lesson-actions">
                        <button onclick="openEditModal(<?= $lesson['id'] ?>, '<?= htmlspecialchars($lesson['title'], ENT_QUOTES) ?>', '<?= htmlspecialchars($lesson['description'], ENT_QUOTES) ?>', '<?= htmlspecialchars($lesson['content'], ENT_QUOTES) ?>', '<?= htmlspecialchars($lesson['video_path'], ENT_QUOTES) ?>', <?= $lesson['order_index'] ?>, <?= $lesson['is_preview'] ?>)" class="btn btn-small btn-primary">Edit</button>
    ...
    <script>
        ...
        function openEditModal(id, title, description, content, videoPath, orderIndex, isPreview) {
