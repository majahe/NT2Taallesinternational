...
<header class="registered-header">
  ...
  <div style="display: flex; gap: 1rem; align-items: center;">
    ...
    <a href="../dashboard/dashboard.php" class="btn small" style="background: white; color: #2c5282;">← Dashboard</a>
  </div>
</header>
...
<div class="filters">
  ...
  <a href="../payments/pending_payments.php" class="btn small" style="background: #ef4444; color: white;">💳 View Pending Payments</a>
</div>
